...
<body>
		...
		<div class="container">
			<div class="row row1">
				<ul class="largenav pull-right">
					...
					<li class="upper-links dropdown"><a class="links"
						href="http://clashhacks.in/"><span
							class="glyphicon glyphicon-th"></span> Products</a></li>
					<li class="upper-links dropdown"><a class="links"
						href="http://clashhacks.in/"><span
							class="glyphicon glyphicon-thumbs-up"></span> Preffered</a></li>
					<li class="upper-links dropdown"><a class="links"
					...
					<li class="upper-links dropdown"><a class="links"
						href="http://clashhacks.in/"><span
							class="glyphicon glyphicon-king"></span> Sign Up</a>
					<li class="upper-links dropdown"><a class="links"
						href="http://clashhacks.in/"><span
							class="glyphicon glyphicon-user"></span> User</a>
						<ul class="dropdown-menu largenav pull-right">
							<li><a href="#"><span class="glyphicon glyphicon-user"></span>
									My Profile</a></li>
							<li><a href="#"><span class="glyphicon glyphicon-heart"></span>
									WishList</a></li>
							<li><a href="#"> <span
									class="glyphicon glyphicon-shopping-cart"></span> MyOrders
							</a></li>
				...
				<div class="col-sm-2">
					<h2 style="margin: 0px;">
						<span class="smallnav menu" onclick="openNav()"><span
							class="glyphicon glyphicon-tasks"></span> VanuShoppee</span>
					</h2>
					<h1 style="margin: 2px;">
					
						<span class="largenav" style="font-size: 20pt;">VanuShoppee</span>
					</h1>
				</div>
				...
				<div class="cart largenav col-sm-2">
					<a class="cart-button"> <svg class="cart-svg " width="16 "
                        ...
                        <path
								...
								fill="#fff "></path>
                    </svg> My cart <span class="item-number ">0</span>
					</a>
				</div>
			</div>
	...
	<div id="mySidenav" class="sidenav">
		<div class="container"
			...
			<span class="sidenav-heading"></a>VanuShoppee</span> <a
		...
		<a class="links"
					...
					<a class="links"
						href="http://clashhacks.in/"><span
							class="glyphicon glyphicon-thumbs-up"></span> Preffered</a>
